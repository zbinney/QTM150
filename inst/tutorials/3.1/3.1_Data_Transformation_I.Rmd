...
quiz(
  ...
  question("Which of the following are **arguments** to **functions** in the above code?",
      ...
      answer("aes(...) where ... means everything inside aes()"),
  ...
  question("Which of the following are **values** to **arguments** in the above code?",
      ...
      answer("mapping ="),
      answer("aes(...) where ... means everything inside aes()", correct = TRUE, message = "aes() and everything inside it is a value to the mapping = function."),
      answer("x ="),
