...
When my husband was planning to propose, he used heirloom diamonds from the ring that his dad had given to his mom. Part of that process involved getting those diamonds appraised. How could he know that he was getting a good deal? Well, we have a good jeweler but, we can also explore the `diamonds` dataset to get an idea of what diamonds of a certain size and quality might be worth! 
...
His mom's diamonds had a "Premium" cut and a color grade of "E". Color grades technically run from D-Z, where just like your grades earlier letters are better. I wonder how these inherited heirlooms compare to this huge dataset of diamonds in cut and color. Did my late father-in-law do good back in the 90's? (NOTE: I actually love non-conventional diamonds and think that all of the flaws in cut, clarity, or color make for really unique pieces! He ended up with a cognac salt and pepper oval shaped diamond for the center stone, but you won't find fun gems like that in this dataset.)
...
Where do my little inherited pieces fit in? Are they a common cut? A common color? Near the best, the worst, or kind of in the middle on both these dimensions?
