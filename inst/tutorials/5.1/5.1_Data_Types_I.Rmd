---
title: "Tutorial 5.1 - Data Types I (Vectors and Lists)"
...
1. A type, of which there are six major ones:
    ...
    We'll focus on the first 4 types today.
...
There is lots more detail to working with **strings**, but we will cover that later. If you want a preview, though, you can see [Chapter 14 of *R for Data Science*](https://r4ds.had.co.nz/strings.html).
...
This may seem arbitrary now, but I assure you it's actually quite useful (just wait until the homework for this Tutorial)!
...
In the `tidyverse` R will actually throw an **error** rather than a **warning** and refuse to run at all - you may have already encountered something like this in `ggplot()`! This is to avoid any unintentional screw-ups, as this uneven recycling can sometimes create big but silent problems in your code.
...
Sometimes R will do something you don't want it to, though (wait 'til you learn about `stringsAsFactors`...), so you need to know about vector types and coercion to be able to identify when it does and correct or undo its mistake.
