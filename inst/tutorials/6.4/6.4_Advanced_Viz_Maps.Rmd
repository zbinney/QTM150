...
How would we plot a rectangle in `ggplot()`? Try this code. We introduce one new **geom** you haven't encountered before, but with your existing skills you should be able to make a good guess about what it does:
...
Now imagine if instead of abstract "X" and "Y" values, these coordinates represented longitudes and latitudes, respectively. 
