...
## Appendix (Optional): More on Factors

Here is a little more on working with factors. If you take QTM 151 we will cover factors and the useful `tidyverse` `forcats` package in greater detail. But for now here are a couple other things you might be interested in:
