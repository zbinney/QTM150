...
Here's the general structure of a function, illustrated with a trivial function that takes a single number as input and checks if it's greater than 2.

```{r fg, eval = FALSE, include = TRUE}
...
```{r func_general_test, exercise = TRUE, exercise.setup = "fg"}
