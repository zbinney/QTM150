...
Every piece of data on a computer is stored in a **file**. 
...
OK, I think that's it for now. I hope this gets everyone on the same page with regards to how files are stored on a computer and how it looks for them when you ask it to.
